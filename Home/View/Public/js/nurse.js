...
$.extend({
    ...
    getNewsListByAllTerm: function () {
        ...
        $.AjaxPost(MODULE+"/Nurse/getNurseList", {currentpage:currentpage_zcj, pagenum:pagenum_zcj,name:name,age1:age1,age2:age2,other:other,status_sh:status_sh,level_name:level_name}, function (backdata) {
