...
$.extend({
    ...
    getNewsListByAllTerm: function () {
        ...
        $.AjaxPost(MODULE+"/Need/getReturnList", {currentpage:currentpage_zcj, pagenum:pagenum_zcj,number:number,status_23:status_23,sales_id:sales_id,employee_id:employee_id}, function (backdata) {
