...
$.extend({
    ...
    getNewsListByAllTerm: function () {
        ...
        $.AjaxPost(MODULE+"/Money/getPriceComeList", {currentpage:currentpage_zcj, pagenum:pagenum_zcj,name:name,number:number,time:time,sales_id:sales_id}, function (backdata) {
            if (backdata.code == 1000) {
                ...
                if(List_zcj!=null){
                    $.each(List_zcj,function(i,item){
                        ...
                        <td width="15%"><a href="' + MODULE + '/Money/orderInfo/id/' + item.id + '.html">收款</a></td>\
                        </tr>';
                    });
                    $dom.before(str);
