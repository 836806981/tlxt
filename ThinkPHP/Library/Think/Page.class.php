...
class Page{
    ...
    public function showFront() {
        ...
        $this->config['header'] = '<li><span class="rows">共 %TOTAL_ROW% 条记录</span></li>';
        ...
        //替换分页内容
        $page_str = str_replace(
            array('%UP_PAGE%', '%HEADER%', '%NOW_PAGE%', '%DOWN_PAGE%', '%FIRST%', '%LINK_PAGE%', '%END%', '%TOTAL_ROW%', '%TOTAL_PAGE%'),
            array($up_page, $this->config['header'], $this->nowPage, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages),
            $this->config['theme']);
        return "{$page_str}";
    }
}